var local_database = [
  ...
  },
  {
    ...
    postId: 1,
    music: {
      url: "http://link.hhtjim.com/qq/000HuKJM21YDTr.mp3",
      title: "Canon in D Major-Jim Brickman",
  ...
  },
  {
    ...
    postId: 2,
    music: {
      url: "http://nf01.sycdn.kuwo.cn/resource/n3/93/73/3606425411.mp3",
      title: "Hoaprox-Ngau Hung/Remix-Ms-TearGas ",
      coverImg: "http://img2.kuwo.cn/star/starheads/120/87/77/1311858681.jpg"
    }
  },
  {
  ...
  },
  {
    ...
    postId: 4,
    music: {
      url: "http://nf01.sycdn.kuwo.cn/resource/n3/65/45/3896840009.mp3",
      title: "My Soul-July ",
      coverImg: "http://img3.kuwo.cn/star/starheads/120/8/6/3574978761.jpg"
    }
  },
  {
    ...
    postId: 5,
    music: {
      url: "http://ri01.sycdn.kuwo.cn/resource/n2/57/58/3204734942.mp3",
      title: "fade-Alan Walker",
      coverImg: "http://img2.kuwo.cn/star/starheads/120/75/50/3322907078.jpg"
    }
  },
]

var a="2"
//把上面的数据发布出去key为postList，其他的js文件可以进行使用
//当然不止是只能发布一个变量，多个变量也是可以的,比如多一个a
module.exports = {
